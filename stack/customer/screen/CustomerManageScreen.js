  ...
  return (
      <View className="px-4 py-2 h-16 flex flex-row justify-center items-center rounded-b-3xl relative z-50 bg-white">
        ...
        <View className="relative">
          <TouchableOpacity>
            <Text className="font-sgbold text-f19 text-center">Quản lý tài khoản</Text>
          </TouchableOpacity>
        </View>
      </View>
  )
    ...
    <View className="flex-1 bg-gray-5 relative">
      ...
      <View className="relative z-50 mt-3 bg-white py-4 rounded-t-3xl flex-1 justify-between">
        <View className="px-4 mt-3">
          <TouchableOpacity onPress={() => navigation.navigate('CustomerResetPin')} className="flex-row justify-between border-b border-gray-200 items-center pb-5">
            <Text className="font-sgmedium text-f16">Đổi mã PIN</Text>
            <View className="">
