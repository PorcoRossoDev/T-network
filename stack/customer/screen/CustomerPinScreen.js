  ...
  return (
    <View className="flex-1 justify-between bg-white pt-5">
      <View className="bg-white">
        ...
        <View className="px-4">
          <Text className="text-center text-2xl font-sgbold mt-8">Nhập mã PIN của bạn</Text>
          <Text className="text-center text-gray-500 mt-3 text-f15 font-sgregular">Nhập mật khẩu để truy cập tài khoản của bạn</Text>
        </View>
        ...
        <View className="px-4 mt-8 relative">
          ...
          <TouchableOpacity onPress={openSheet} className="mt-4">
              <Text className="text-center font-sgbold text-blue-600">Quên mã PIN?</Text>
          </TouchableOpacity>
        </View>
      </View>
      ...
      <View className="px-4">
        <TouchableOpacity onPress={handleGuestLogin} disabled={disableButton} className={`${disableButton?'bg-gray-300':'bg-primary'}  rounded-[40px] h-16 justify-center items-center`}>
          <Text className="text-white text-center font-sgbold text-f17">Xác nhận mã PIN</Text>
        </TouchableOpacity>
      </View>
...
export default CustomerPinScreen