    ...
    <ScrollView className='flex-1'>
      <View className=''>
        <View className='justify-center bg-gray-100 items-center'>
          ...
          <View className='w-[85%] py-10 mt-10 justify-center items-center bg-white rounded-t-2xl'>
            <TouchableOpacity onPress={() => navigation.navigate('OrderAddStack')} className='justify-center text-center'>
              ...
              <Text className='text-f16 mt-4 font-sfmedium'>Tạo sản phẩm</Text>
            </TouchableOpacity>
          </View>
        </View>
        ...
        <View className='bg-white px-5 mb-3'>
          <TouchableOpacity onPress={() => navigation.navigate('ProductListStack')} className='flex-row justify-between items-center py-4 border-b border-gray-100'>
            <View className='flex-row items-center'>
              <HeroSolid.ClipboardDocumentListIcon size={30} color={'#6b7280'} />
              <Text className='pl-3 font-sfregular text-f15'>Danh sách sản phẩm</Text>
            </View>
          ...
          <TouchableOpacity onPress={() => navigation.navigate('ProductCategoryStack')} className='flex-row justify-between items-center py-4 border-b border-gray-100'>
            <View className='flex-row items-center'>
              <HeroSolid.ClipboardDocumentCheckIcon size={30} color={'#6b7280'} />
              <Text className='pl-3 font-sfregular text-f15'>Loại sản phẩm</Text>
            </View>
            <View className='flex-row flex-wrap items-center'>
          ...
          <TouchableOpacity onPress={()=> navigation.navigate('ProductBrandStack')} className='flex-row justify-between items-center py-4 border-b border-gray-100'>
            <View className='flex-row items-center'>
              <HeroSolid.ReceiptRefundIcon size={30} color={'#6b7280'} />
              <Text className='pl-3 font-sfregular text-f16'>Nhãn hiệu</Text>
            </View>
            <View className='flex-row flex-wrap items-center'>
          ...
          <TouchableOpacity onPress={()=> navigation.navigate('AttributeStack')} className='flex-row justify-between items-center py-4 border-b border-gray-100'>
            <View className='flex-row items-center'>
              <HeroSolid.DocumentChartBarIcon size={30} color={'#6b7280'} />
              <Text className='pl-3 font-sfregular text-f16'>Thuộc tính</Text>
            </View>
            <View className='flex-row flex-wrap items-center'>
                <Text className='text-f12'>50</Text>
                <Text className='ml-2'>
