...
const timelineSteps = [
  { title: "Tạo công việc", time: "15:55 13/11/2025", status: "done" },
  { title: "Duyệt công việc", time: "16:10 13/11/2025", status: "done" },
  { title: "Hoàn thành", time: null, status: "pending" },
  { title: "Huỷ", time: null, status: "canceled" },
];

const history = [
  { time: "15:55 13/11/2025", title: "Tạo công việc mới bởi Phạm Phương Thúy" },
  { time: "16:10 13/11/2025", title: "Công việc đã được duyệt" },
  { time: "16:10 13/11/2025", title: "Công việc đã được duyệt bởi Admin" },
];
    ...
    <ScrollView className='bg-white p-5'>
      ...
      <View className="flex-row justify-between mb-4">
        <TouchableOpacity className="flex-1 bg-blue-500 py-2 rounded-lg items-center mr-2">
          <Text className="text-white font-semibold">In công việc</Text>
        </TouchableOpacity>

        <TouchableOpacity className="flex-1 border border-blue-500 py-2 rounded-lg items-center mr-2">
          <Text className="text-blue-500 font-semibold">Duyệt công việc</Text>
        </TouchableOpacity>
      ...
      <Text className="text-f16 font-sfbold mb-3">Trạng thái công việc</Text>
      ...
      <View className="p-4 rounded-xl border border-gray-200 bg-white shadow-sm mt-4">
        ...
        <View className="flex-row mb-2">
          <Text className="w-28 font-semibold text-black">Tên công việc:</Text>
