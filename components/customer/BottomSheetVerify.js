...
const BottomSheetVerify = forwardRef((props, ref) => {
      ...
      <BottomSheetView className=''>
        <View className='mt-3'>
          <View className="bg-white">
            ...
            <View className="px-4">
              <Text className="text-xl font-sgbold">Xác minh tài khoản</Text>
              <Text className="text-gray-500 mt-1 text-f15 font-sgregular">Xác minh để nhận thông tin mới nhất</Text>
            </View>
...
export default BottomSheetVerify;
