...
const ProductBrandStack = ({ navigation }) => {
          ...
          <View className='mb-5 pb-5 border-b flex-row justify-between items-start border-gray-200'>
            <View className='flex-col justify-between'>
                ...
                <View className='flex-row items-center' style={{includeFontPadding: false,}}>
                    <Text className='text-gray-500 font-sfregular text-md mt-1'>Admin Sunvboy</Text>
                </View>
            </View>
          ...
          <View className='bg-white w-[80%] rounded-lg'>
            <View className='px-3 py-3'>
              <Text className='text-center font-sfbold mb-4 text-f17 mt-2'>Cập nhật</Text>
                <View>
                  <Text className='text-red-600 font-sfregular'>* <Text className='text-gray-500 font-sfregular'>Tên loại sản phẩm</Text></Text>
                  <TextInput 
                    value=''
...
export default ProductBrandStack;
