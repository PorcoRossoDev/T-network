  ...
  return (
    <SafeAreaView className="flex-1 justify-between bg-white">
      <View className="bg-white mt-10">
        ...
        <View className="px-4">
          <Text className="text-center text-3xl font-medium mt-8">Nhập mã PIN của bạn</Text>
          <Text className="text-center text-gray-500 mt-3 text-f15">Nhập mật khẩu để truy cập tài khoản của bạn</Text>
        </View>
